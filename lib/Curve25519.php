...
class Curve25519
{
    ...
    function mulHalf($a7, $a6, $a5, $a4, $a3, $a2, $a1, $a0, $b7, $b6, $b5, $b4, $b3, $b2, $b1, $b0)
    {
        return [
            ($carry = $a0*$b0) % 0x10000,
            ($carry = ($carry >> 16) + $a0*$b1 + $a1*$b0) % 0x10000,
            ($carry = ($carry >> 16) + $a0*$b2 + $a1*$b1 + $a2*$b0) % 0x10000,
            ($carry = ($carry >> 16) + $a0*$b3 + $a1*$b2 + $a2*$b1 + $a3*$b0) % 0x10000,
            ($carry = ($carry >> 16) + $a0*$b4 + $a1*$b3 + $a2*$b2 + $a3*$b1 + $a4*$b0) % 0x10000,
            ($carry = ($carry >> 16) + $a0*$b5 + $a1*$b4 + $a2*$b3 + $a3*$b2 + $a4*$b1 + $a5*$b0) % 0x10000,
            ($carry = ($carry >> 16) + $a0*$b6 + $a1*$b5 + $a2*$b4 + $a3*$b3 + $a4*$b2 + $a5*$b1 + $a6*$b0) % 0x10000,
            ($carry = ($carry >> 16) + $a0*$b7 + $a1*$b6 + $a2*$b5 + $a3*$b4 + $a4*$b3 + $a5*$b2 + $a6*$b1 + $a7*$b0) % 0x10000,
            ($carry = ($carry >> 16) + $a1*$b7 + $a2*$b6 + $a3*$b5 + $a4*$b4 + $a5*$b3 + $a6*$b2 + $a7*$b1) % 0x10000,
            ($carry = ($carry >> 16) + $a2*$b7 + $a3*$b6 + $a4*$b5 + $a5*$b4 + $a6*$b3 + $a7*$b2) % 0x10000,
            ($carry = ($carry >> 16) + $a3*$b7 + $a4*$b6 + $a5*$b5 + $a6*$b4 + $a7*$b3) % 0x10000,
            ($carry = ($carry >> 16) + $a4*$b7 + $a5*$b6 + $a6*$b5 + $a7*$b4) % 0x10000,
            ($carry = ($carry >> 16) + $a5*$b7 + $a6*$b6 + $a7*$b5) % 0x10000,
            ($carry = ($carry >> 16) + $a6*$b7 + $a7*$b6) % 0x10000,
            ($carry = ($carry >> 16) + $a7*$b7) % 0x10000,
                      ($carry >> 16)
        ];
    }
    ...
    function mul(array $a, array $b) {
        ...
        return $this->reduce([
            ($carry = 0x800000                  + $e[ 0] + ($f[ 8] -$d[ 8] -$e[ 8] + $d[ 0] -0x80) * 38) % 0x10000,
            ($carry = 0x7fff80 + ($carry >> 16) + $e[ 1] + ($f[ 9] -$d[ 9] -$e[ 9] + $d[ 1]) * 38) % 0x10000,
            ($carry = 0x7fff80 + ($carry >> 16) + $e[ 2] + ($f[10] -$d[10] -$e[10] + $d[ 2]) * 38) % 0x10000,
            ($carry = 0x7fff80 + ($carry >> 16) + $e[ 3] + ($f[11] -$d[11] -$e[11] + $d[ 3]) * 38) % 0x10000,
            ($carry = 0x7fff80 + ($carry >> 16) + $e[ 4] + ($f[12] -$d[12] -$e[12] + $d[ 4]) * 38) % 0x10000,
            ($carry = 0x7fff80 + ($carry >> 16) + $e[ 5] + ($f[13] -$d[13] -$e[13] + $d[ 5]) * 38) % 0x10000,
            ($carry = 0x7fff80 + ($carry >> 16) + $e[ 6] + ($f[14] -$d[14] -$e[14] + $d[ 6]) * 38) % 0x10000,
            ($carry = 0x7fff80 + ($carry >> 16) + $e[ 7] + ($f[15] -$d[15] -$e[15] + $d[ 7]) * 38) % 0x10000,
            ($carry = 0x7fff80 + ($carry >> 16) + $e[ 8] +  $f[ 0] -$d[ 0] -$e[ 0] + $d[ 8]  * 38) % 0x10000,
            ($carry = 0x7fff80 + ($carry >> 16) + $e[ 9] +  $f[ 1] -$d[ 1] -$e[ 1] + $d[ 9]  * 38) % 0x10000,
            ($carry = 0x7fff80 + ($carry >> 16) + $e[10] +  $f[ 2] -$d[ 2] -$e[ 2] + $d[10]  * 38) % 0x10000,
            ($carry = 0x7fff80 + ($carry >> 16) + $e[11] +  $f[ 3] -$d[ 3] -$e[ 3] + $d[11]  * 38) % 0x10000,
            ($carry = 0x7fff80 + ($carry >> 16) + $e[12] +  $f[ 4] -$d[ 4] -$e[ 4] + $d[12]  * 38) % 0x10000,
            ($carry = 0x7fff80 + ($carry >> 16) + $e[13] +  $f[ 5] -$d[ 5] -$e[ 5] + $d[13]  * 38) % 0x10000,
            ($carry = 0x7fff80 + ($carry >> 16) + $e[14] +  $f[ 6] -$d[ 6] -$e[ 6] + $d[14]  * 38) % 0x10000,
    ...
    {
        return $this->reduce([
            ($carry =                  $a[ 0] * 121665) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 1] * 121665) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 2] * 121665) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 3] * 121665) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 4] * 121665) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 5] * 121665) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 6] * 121665) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 7] * 121665) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 8] * 121665) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 9] * 121665) % 0x10000,
            ($carry = ($carry >> 16) + $a[10] * 121665) % 0x10000,
            ($carry = ($carry >> 16) + $a[11] * 121665) % 0x10000,
            ($carry = ($carry >> 16) + $a[12] * 121665) % 0x10000,
            ($carry = ($carry >> 16) + $a[13] * 121665) % 0x10000,
            ($carry = ($carry >> 16) + $a[14] * 121665) % 0x10000,
    ...
    {
        $carry2 = ($carry = $a[15]) % 0x8000;
        return [
            ($carry = ($carry >> 15) * 19 + $a[0]) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 1]) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 2]) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 3]) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 4]) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 5]) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 6]) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 7]) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 8]) % 0x10000,
            ($carry = ($carry >> 16) + $a[ 9]) % 0x10000,
            ($carry = ($carry >> 16) + $a[10]) % 0x10000,
            ($carry = ($carry >> 16) + $a[11]) % 0x10000,
            ($carry = ($carry >> 16) + $a[12]) % 0x10000,
            ($carry = ($carry >> 16) + $a[13]) % 0x10000,
            ($carry = ($carry >> 16) + $a[14]) % 0x10000,
                      ($carry >> 16) + $carry2
        ];
    }
